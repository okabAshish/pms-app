    ...
    return (
        ...
        <View style={{paddingHorizontal: 20, paddingVertical: 0}}>
            ...
            <TenantInvitationCard
                ...
                key={index + 1}
                invited_by= {item?.owner_data?.first_name + ' '+ item?.owner_data?.last_name} 
                property_id= {item?.invited_property_data?.prefix +'_'+ item?.invited_property_data?.id.toString().padStart(5, '0')} 
