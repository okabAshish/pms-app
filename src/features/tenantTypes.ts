...
export interface MaintenanceRequestMediaList
  extends Array<MaintenanceRequestMedia> {}
...
export interface MaintenanceCategoryDropdownListSingleData {
  id: number;
  category_name: string;
  created_at: string;
  updated_at: string;
...
export interface MaintenanceCategoryDropdownList
  extends Array<MaintenanceCategoryDropdownListSingleData> {}

export interface MaintenancePriorityDropdownListSingleData {
  id: number;
  priority_name: string;
  created_at: string;
  updated_at: string;
...
export interface MaintenanceCategoryPriorityList
  extends Array<MaintenancePriorityDropdownListSingleData> {}

export interface MaintenanceDropdown {
  maintenance_category: MaintenanceCategoryDropdownList;
  maintenance_priority: MaintenanceCategoryPriorityList;
  maintenance_property: Array<RentedProperty>;
}

export interface MaintenanceDropdownListResponse {
  success: boolean;
  data?: MaintenanceDropdown;
  message: string;
}

export interface AddMaintenanceRequestResponseData {
  success: boolean;
  data?: any;
  message: string;
}

export interface AddMaintenanceRequestRequestBody {
  issue_details: string;
  property_id: string;
  maint_category_id: string;
  priority_id: string;
  issue_date: any;
  is_image_added: boolean;
  image: any;
}

export interface MaintenanceDetailsResponseData {
  success: boolean;
  data: MaintenanceRequest;
  message: string;
}

export interface TransactionListSingleData {
  id: number;
...
export interface TransactionListData extends Array<TransactionListSingleData> {}

export interface TransactionListLimitData {
