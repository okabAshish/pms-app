...
export interface CompanyTypeArray {
  id: number;
  name: string;
  description?: string;
  created_at?: string;
...
export interface CompanyTypeResponse extends Array<CompanyTypeArray> {}

export interface CompanyTypeResponseData {
  success: boolean;
  data: CompanyTypeResponse;
  message: string;
}

export interface UserProfileDetailResponseData {
  success: boolean;
  data: {
    id: number;
    user_id: number;
...
export interface ForgotPasswordCheckUserResponseData {
  success: boolean;
  data: {
    user_id: number;
    otp: number;
...
export interface ForgotPasswordCheckUserRequestBody {
  body: {username: string; role_id: string};
}

export interface ForgotPasswordVerifyUserResponseData {
  success: boolean;
  data: {
    user_id: number;
  };
...
export interface ForgotPasswordVerifyUserRequestBody {
